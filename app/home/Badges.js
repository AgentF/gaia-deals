...
export const StatusBadge = ({ status, className }) => {
  const badgeStyle =
    status == 0 ? 'bg-green-200 text-green-800' : 'bg-gray-200 text-gray-800';
  return (
    <span
...
export const BadgeProfile = ({ percent = 100, textDone = "5/5" }) => {
  ...
  return (
    ...
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="30pt" height="24pt" version="1.0" viewBox="0 0 36 36"
      >
        <text font-size="1.5em" x="50%" y="50%" class="base" fill="currentColor" dominant-baseline="middle" text-anchor="middle">{percent}</text>
      </svg>
